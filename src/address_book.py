...
class Record:
    ...
    def __str__(self):
        return f"{self.__class__.__name__}(name={self.name.value}, phones={self.phones}, birthday={self.birthday}, address={self.address}, emails={self.emails}, notes={self.notes})"
